        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Kelola Galang Dana</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Data Pengajuan Galang Dana</h4>
                            </div>
                            <div class="text-right">
                            <a href="<?php echo site_url('Admin/form_tambah_dana');?>"><button class="btn-primary btn btn-xs" type="submit">Tambah Data</button></a>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped table-bordered table-hover dataTables-example" style=" ">
                                    ...
                                    <tbody>
                                        <?php foreach ($data_dana as $r): ?>
                                        <tr>
                                            <td><?php echo $r['id_galangdana']?></td>
                                            <td><?php echo $r['id_user']?></td>
                                            <td><?php echo $r['judul_galdan']?></td>
                                            <td><?php echo $r['kategori_galdan']?></td>
                                            <td><?php echo $r['target_donasi']?></td>
                                            <td><?php echo $r['akhir_donasi']?></td>
                                            <td><?php echo $r['deskripsi']?></td>
                                            <td><img src="<?php echo base_url();?>assets/admin/img/upload/<?=$r['foto_utama'] ?>" width='100' height='100'></td>
                                            <!--<td><a href="<?php echo base_url();?>assets/admin/img/upload/<?=$r['surat_ket']?>">Download file</a></td>-->
                                            <td><a href="<?php echo base_url();?>assets/admin/img/upload/<?=$r['proposal']?>">Download file</a></td>
                                            <td>
                                                <?php echo $r['status']?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('index.php/Crud/form_edit_dana/'.$r['id_galangdana']) ?>"><button class="btn-primary btn btn-xs" type="submit">Edit</button></a>
                                                    <a href="<?php echo base_url('index.php/Crud/do_delete_dana/'.$r['id_galangdana']) ?>" onclick="return confirm('Yakin ingin hapus data?')"><button class="btn-danger btn btn-xs" type="submit">Hapus</button></a>
                                                </div>
                                            </td>
                                        <?php endforeach ?>
                                        </tr>
