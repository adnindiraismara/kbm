            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Kelola Program Relawan</h4>
                            </div>
                            <div class="content">
                                <?php echo form_open("Admin/tambah_program", array('enctype'=>'multipart/form-data')); ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Judul Program</label>
                                                <input type="text" name="input_judul_program" value="<?php echo set_value('input_judul_program');?>" placeholder="Masukkan data" method="post" class="form-control">
                                            </div>   
                                        </div>
                                    </div>
                                    <div class="row">
                                   ...
                                   <input type="submit" class="btn btn-primary btn-info btn-fill pull-right" name="submit" value="Simpan"></a>
                                    <a href="<?php echo base_url('index.php/Admin/dataprogram')?>"><button type="button" class="btn btn-danger btn-info btn-fill pull-right" data-dismiss="modal">Tutup</button></a>
