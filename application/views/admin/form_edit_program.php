...
<head>
    ...
    <title>Admin | Data Program Relawan</title>
            ...
            <div class="modal-dialog">
                <div class="modal-content animated bounceInDown">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Data Program Relawan</h4>
                                            <small class="font-bold">Kabupaten Bogor Mengajar</small>
                                        </div> 
                                <form class="m-t" role="form" action="<?php echo base_url('index.php/Crud/do_edit_program')?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body"> 
                                    <?php echo "<h2>".$this->session->flashdata("pesan")."</h2>" ?>
                                 <p><strong>Edit Data Program</strong></p>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Judul Program</label>
                                                <input type="text" name="judul_program" value="<?php echo $judul_program?>" placeholder="Masukkan data" method="post" class="form-control">
                                            </div>   
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"><label for="exampleFormControlFile1">Gambar Program</label> 
                                                    <input type="file" name="input_file" value="<?php echo $foto_program?>" class="form-control-file" id="exampleFormControlFile1">
                                                </div>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right">Upload Program</button>
                                    <a href="<?php echo base_url('index.php/Admin/dataprogram')?>"><button type="button" class="btn btn-danger btn-info btn-fill pull-right" data-dismiss="modal">Batalkan</button></a>
