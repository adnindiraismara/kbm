            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Data Campaign<td>
                                    </td></h4>
                            </div>
                            <div class="text-right">
                            <a href="<?php echo site_url('Admin/form_tambah_campaign');?>"><button class="btn-primary btn btn-xs" type="submit">Tambah Data</button></a>
                            </div>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped table-bordered table-hover dataTables-example" style=" ">
                                    ...
                                    <tbody>
                                    <?php 
                                    foreach ($data_campaign as $r) 
                                        { ?>
                                        <tr>
                                            <td><?php echo $r['id_campaign']?></td>
                                            <td><?php echo $r['kategori']?></td>
                                            <td><?php echo $r['judul_campaign']?></td>
                                            <td><?php echo $r['deskripsi']?></td>
                                            <td><?php echo $r['target_donasi']?></td>
                                            <td><img src="<?php echo base_url();?>assets/admin/img/upload/<?=$r['foto_campaign'] ?>" width='100' height='100'></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('index.php/Crud/form_edit_campaign/'.$r['id_campaign']) ?>"><button class="btn-primary btn btn-xs" type="submit">Edit</button></a>
                                                    <a href="<?php echo base_url('index.php/Crud/do_delete_campaign/'.$r['id_campaign']) ?>" onclick="return confirm('Yakin ingin hapus data?')"><button class="btn-danger btn btn-xs" type="submit">Hapus</button></a>
                                                </div>
                                            </td>
                                        <?php }?>
                                        </tr>
