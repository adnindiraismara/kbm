            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Data User<td>
                                    </td></h4>
                            </div>
                            <div class="text-right">
                            <a href="<?php echo site_url('Admin/form_tambah_user');?>"><button class="btn-primary btn btn-xs" type="submit">Tambah Data</button></a>
                            </div>
                                    ...
                                    foreach ($hasil as $r) 
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('index.php/Crud/form_edit_user/'.$r['id_user']) ?>"><button class="btn-primary btn btn-xs" type="submit">Edit</button></a>
                                                    <a href="<?php echo base_url('index.php/Crud/do_delete_user/'.$r['id_user']) ?>" onclick="return confirm('Yakin ingin hapus data?')"><button class="btn-danger btn btn-xs" type="submit">Hapus</button></a>
                                                </div>
                                            </td>
                                            <?php }?>
                                        </tr>
