            ...
            <div class="modal-dialog">
                <div class="modal-content animated bounceInDown">
                                        <div class="modal-header">
                                            <a href="<?php echo base_url('index.php/Admin/datauser')?>"><button type="button" class="close" data-dismiss="modal"aria-label="Close"> <span aria-hidden="true">&times;</span><span class="sr-only">Tutup</span></button>
                                        </a>
                                            <i class="fa fa-laptop modal-icon"></i>
                                            <h2 class="modal-title"> <center>DAFTAR</center></h2>
                                            <h4 class="font-bold"><center>Kabupaten Bogor Mengajar</center></h4>
                                        </div>
                                        
                                <form class="m-t" role="form" action="<?php echo base_url('index.php/Crud/do_insert_user')?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <?php echo "<h2>".$this->session->flashdata("pesan")."</h2>" ?>
                                            <p><strong>Untuk mendaftar, silahkan masukan data kamu!</strong></p>
