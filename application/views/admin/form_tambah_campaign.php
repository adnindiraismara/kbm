        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Kelola Campaign</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Kelola Campaign</h4>
                            </div>
                            <div class="content">
                                <?php echo form_open("Admin/tambah_campaign", array('enctype'=>'multipart/form-data')); ?>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="input_judul_campaign" value="<?php echo set_value('input_judul_campaign');?>" placeholder="Masukkan data" method="post" class="form-control">
                                            </div>   
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="input_target_donasi" value="<?php echo set_value('input_target_donasi');?>" class="form-control" placeholder="Rp. ...">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="input_akhir_donasi" value="<?php echo set_value('input_akhir_donasi');?>" class="form-control" placeholder="Batas Akhir">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <a href="<?php echo base_url('index.php/Admin/datacampaign')?>"><button type="button" class="btn btn-danger btn-info btn-fill pull-right" data-dismiss="modal">Tutup</button></a>
