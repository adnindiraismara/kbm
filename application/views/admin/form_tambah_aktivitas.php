        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Kelola Aktivitas</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"> Kelola Aktivitas </h4>
                            </div>
                            <div class="content">
                                <?php echo form_open("Admin/tambah_aktivitas", array('enctype'=>'multipart/form-data')); ?>
                                    <div class="row">
                                        <div class="col-md-6">
                                              <label for="sel1">Pilih Kategori</label>
                                              <select type="text" name="input_kategori" value="<?php echo set_value('input_kategori');?>"placeholder="Masukkan data" class="form-control"> 
                                                ...
                                                <option value="Donasi Program">Kemanusiaan</option>
                                                <option value="Donasi Program">Hiburan</option>
                                            </select>
                                            </div>                                         
                                            <div class="col-md-6">
                                            <div class="form-group"><label>Judul Aktivitas</label> 
                                                    <input type="text" name="input_judul_aktivitas" value="<?php echo set_value('input_judul_aktivitas');?> "placeholder="Masukkan data" class="form-control">
                                                </div> 
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"><label>Narasi</label> 
                                                    <input type="text-area" name="input_narasi" value="<?php echo set_value('input_narasi');?>"placeholder="Masukkan data" class="form-control">
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"><label for="exampleFormControlFile1">Foto</label> 
                                    ...
                                    <a href="<?php echo base_url('index.php/Admin/dataaktivitas')?>"><button type="button" class="btn btn-danger btn-info btn-fill pull-right" data-dismiss="modal">Tutup</button></a>
